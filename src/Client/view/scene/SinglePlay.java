...
import singlemode.ArtificialIntelligence;
import singlemode.JCanvas;
import singlemode.JEventQueue;
...
//extends javax.swing.JFrame
    ...
    public static void InitGUI() {
        ...
        ExitButton.setBounds(ButtonPositionX, 3 * marginButton, widthButton, heightButton);
    ...
    public static void InitEventListener() {
        ...
        Events.listenTo(ExitButton, "Exit");
    ...
    public static void GamePlaying() {
        ...
        while (true) {
            ...
            if (name.equals("Exit")) {
                //RunClient.closeScene(RunClient.SceneName.SINGLEPLAY);
                SinglePlay.exit();
                continue;
            }
