...
public class SocketHandler {
    ...
    public void onReceiveGameEvent(String received) {
        ...
        switch (gameEventType) {
            ...
            case MOVE:
                ...
                String _username = splitted[4];

                RunClient.inGameScene.addPoint(row, column, _username);
                RunClient.inGameScene.changeTurnFrom(_username);
                break;

            case WIN:
                String winUserName = splitted[2];
                RunClient.inGameScene.setWin(winUserName);
                break;
            ...
            case TURN_TIMER_END:
                String winnerUserName = splitted[2];
                RunClient.inGameScene.setWin(winnerUserName);
                break;
    ...
    public void editProfile(String newUserName, String name, String avatar, String yearOfBirth, String gender) {
        // prepare data
